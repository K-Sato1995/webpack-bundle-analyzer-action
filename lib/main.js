...
function run() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield (0, analyze_bundle_1.analyzeBundle)(configPath, consts_1.OUTPUT_FILE_PATH);
            yield (0, upload_artifact_1.uploadReport)(consts_1.OUTPUT_FILE_PATH);
            if (prNumber) {
                const pathToStats = `${process.env.GITHUB_WORKSPACE}/${consts_1.OUTPUT_FILE_PATH}.json`;
                const webpackStatsData = yield (0, utils_1.webpackStatsJson)(pathToStats);
                const mdTable = (0, utils_1.constructMDTable)(webpackStatsData);
