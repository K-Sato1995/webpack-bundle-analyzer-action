...
exports.constructMDTable = exports.formatBytes = exports.webpackStatsJson = void 0;
...
const constructMDTable = (dataRows) => {
    const rowStrs = dataRows.map(({ label, statSize, parsedSize, gzipSize }) => {
        return `| \`${label}\` | ${formatBytes(statSize)} | ${formatBytes(parsedSize)} | ${formatBytes(gzipSize)} |`;
    });
    return `
